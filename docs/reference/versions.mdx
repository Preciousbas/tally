---
title: Versions
description: Pins from this repository. Drift if origin/main moves.
---
...
<Warning>
`npm` and `origin/main` can move independently. Re-read `package.json` and the README compile line before treating this table as current.
</Warning>
...
<CardGroup cols={2}>
  <Card title="Contributing" href="/contributing">
    Compile +0.31.1 and run tests.
  </Card>
  <Card title="Contract reference" href="/contract">
    Circuits verified against tally.compact.
  </Card>
</CardGroup>
