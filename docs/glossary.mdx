---
title: Glossary
description: Plain meaning, then the mechanism, then the owner page.
---
...
<CardGroup cols={2}>
  <Card title="Lifecycle" href="/lifecycle">
    The six seals in order.
  </Card>
  <Card title="Contract" href="/contract">
    Circuit names and ledger fields.
  </Card>
</CardGroup>
