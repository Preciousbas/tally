---
title: Standing
description: A membership proof answers yes or no. It does not name a leaf, amount, or counterparty.
---
...
<CardGroup cols={2}>
  ...
  <Card title="Verify access" href="/verify/overview">
    How a third party checks a root on the desk.
  </Card>
</CardGroup>
