...
Live desk: [https://tally-jet-mu.vercel.app](https://tally-jet-mu.vercel.app) · [Demo video](https://drive.google.com/file/d/1kvrBCWi8tmJ0JUSjKFEFucGfp7BwmIAZ/view?usp=sharing)
...
<CardGroup cols={2}>
  ...
  <Card title="Demo video" href="/docs/demo" icon="clapperboard">
    Desk walkthrough with audio — Offer through Verifier Pass.
  </Card>
